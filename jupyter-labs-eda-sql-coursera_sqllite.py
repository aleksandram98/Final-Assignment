...
get_ipython().run_line_magic('sql', 'select * from SPACEXTABLE limit 5')
...
get_ipython().run_line_magic('sql', "select SUM(PAYLOAD_MASS__KG_) from SPACEXTABLE where Customer = 'NASA (CRS)' group by Customer;")
...
get_ipython().run_line_magic('sql', 'select distinct(Landing_Outcome) from SPACEXTABLE;')
...
get_ipython().run_line_magic('sql', "select Payload from SPACEXTABLE where Landing_Outcome = 'Success (drone ship)' and PAYLOAD_MASS__KG_ > 4000 and PAYLOAD_MASS__KG_ < 6000")
...
get_ipython().run_line_magic('sql', 'select distinct (Mission_Outcome) from SPACEXTABLE;')
...
get_ipython().run_line_magic('sql', "select substr(Date, 6,2) as Month, Landing_Outcome, Booster_Version, Launch_Site from SPACEXTABLE where Landing_Outcome = 'Failure (drone ship)' and substr(Date,0,5)='2015';")
...
get_ipython().run_line_magic('sql', "select Landing_Outcome, count(Landing_Outcome) from SPACEXTABLE where (Landing_Outcome = 'Failure (drone ship)' or Landing_Outcome = 'Success (ground pad)') and (Date > '2010-06-04' and Date < '2017-03-20') group by Landing_Outcome order by count(Landing_Outcome) desc;")
